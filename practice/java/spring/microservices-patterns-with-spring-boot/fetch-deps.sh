#!/bin/bash
# Downloads the real Spring Framework, Spring Boot, Resilience4j, and
# JUnit 5 jars used by this pack's microservices-pattern demos, directly
# from Maven Central -- no Maven/Gradle install required. Jars are
...
fetch "https://repo1.maven.org/maven2/io/github/resilience4j/resilience4j-core/$R4J_VER/resilience4j-core-$R4J_VER.jar" resilience4j-core.jar
fetch "https://repo1.maven.org/maven2/io/github/resilience4j/resilience4j-circuitbreaker/$R4J_VER/resilience4j-circuitbreaker-$R4J_VER.jar" resilience4j-circuitbreaker.jar
