...
- [Distributed Transactions, Saga, and Outbox](../handbook/system-design/distributed-transactions-saga-and-outbox.md) — the canonical technical chapter covering the dual-write and reconciliation pattern this chapter's illustrative example draws its shape from.
