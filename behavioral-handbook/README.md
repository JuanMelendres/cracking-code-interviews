...
- `interview-playbook/behavioral/` — currently empty (`.gitkeep` only); a natural home for a future condensed drill/flashcard layer referencing these chapters, once built.
