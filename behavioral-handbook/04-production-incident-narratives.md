...
- [Memory Leak Diagnosis and Heap Dump Analysis](../handbook/jvm/memory-leak-diagnosis-and-heap-dump-analysis.md) — the canonical technical chapter behind this chapter's specific illustrative example.
