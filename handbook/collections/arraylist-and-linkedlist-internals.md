...
related:
  ...
  - arraydeque-internals-and-the-legacy-stack-problem.md
...
- [ArrayDeque Internals and the Legacy Stack/Vector Problem](arraydeque-internals-and-the-legacy-stack-problem.md) — T-204, the real, measured case for `ArrayDeque` over both `LinkedList`-as-queue and legacy `Stack`.
