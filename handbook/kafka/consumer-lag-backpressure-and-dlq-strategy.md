...
- **Retry storms amplifying load on a struggling downstream dependency** — a naive
  ...
  underlying problem worse; see [Resilience Patterns: Circuit Breaker, Retry Jitter, Timeouts, and Bulkheads](../system-design/resilience-patterns.md)
...
| Is the downstream failure a data problem (poison message) or a capacity problem (overload)? | Data problem → DLQ; capacity problem → see [Rate Limiting and Throttling Algorithms](../system-design/rate-limiting-and-throttling-algorithms.md) |
