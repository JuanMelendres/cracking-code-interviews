...
> **Closes an open reference from a related chapter.** [CQRS: Read/Write Separation](cqrs-read-write-separation.md)
...
it). This differs from [CQRS](cqrs-read-write-separation.md), which separates read
...
- **Treating an event log as mutable** — any correction to a "wrong" past event must
  ...
  covered in [Distributed Transactions: Saga, Outbox, and 2PC](../system-design/distributed-transactions-saga-and-outbox.md)'s
...
- Version event schemas deliberately, using the same compatibility-mode discipline
  covered in [Schema Registry and Compatibility Evolution](../kafka/schema-registry-and-compatibility-evolution.md),
...
- [CQRS: Read/Write Separation](cqrs-read-write-separation.md) is this chapter's own
