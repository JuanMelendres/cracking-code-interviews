...
**Expected answer.** Depends entirely on the partitioning scheme — naive `hash % N` remaps nearly everything (measured directly in [Consistent Hashing](../system-design/data-partitioning-and-consistent-hashing.md#internal-implementation): 92.5%); consistent hashing moves only roughly `1/N` of the data.
...
**Related references.** [§ Core Concepts](#core-concepts); [Consistent Hashing](../system-design/data-partitioning-and-consistent-hashing.md).
