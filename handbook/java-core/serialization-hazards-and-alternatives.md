...
- [OWASP Top 10 for Backend Services](../security/owasp-top-10-for-backend-services.md) — deserialization of untrusted data as one of the OWASP Top 10's recurring "untrusted data treated as code" failure shapes, the broader security framing this chapter's Java-specific mechanics sit within.
