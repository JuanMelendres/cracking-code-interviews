...
> **See also:** [Distributed Systems Failure Modes](distributed-systems-failure-modes.md) measures retry amplification (why retrying a merely-slow request adds load rather than replacing it) — a distinct, complementary mechanism from this chapter's jitter measurement (why *synchronized* retries specifically create a storm).
