...
> **Closes a third open forward reference.** [Distributed Transactions: Saga, Outbox, and 2PC](distributed-transactions-saga-and-outbox.md)
...
- **CDC's real operational cost: retention.** A CDC consumer (or its underlying
  ...
  [MVCC in PostgreSQL, Vacuum, and Bloat](../databases/mvcc-vacuum-and-bloat.md)'s
...
directly, and is a good companion to [Consumer Lag, Backpressure, and DLQ Strategy](../kafka/consumer-lag-backpressure-and-dlq-strategy.md)'s
...
- [Distributed Transactions: Saga, Outbox, and 2PC](distributed-transactions-saga-and-outbox.md)
