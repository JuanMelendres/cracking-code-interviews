...
Forty-eight cheat sheets exist so far, ranked by each canonical chapter's own stated IWI (interview-weight-index) — built across nine bounded batches, per `CLAUDE.md`'s instruction against generating an entire deliverable in one operation. 27 chapters remain uncovered.
