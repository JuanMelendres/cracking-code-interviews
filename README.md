...
| | |
|---|---|
| **Phase** | **Plan A complete (Weeks 1–6). Plan B underway, Week 8 done.** |
| **Completed** | Phase 1 Audit · Phase 2 Blueprint · Phase 3 Corrections · Phase 3 Roadmap (`00-project/`) · **`study-packs/week-01` through `week-08`, in full** |
| **In progress** | Plan B, Week 9 (Concurrency + JVM — Checkpoint) |
| **Not started** | Plan B Weeks 10–12 · handbook chapters · interview playbook (beyond what's embedded in study packs) |
...
│   ├── week-07..08/        Plan B — complete
│   └── week-09../          Plan B — in progress
