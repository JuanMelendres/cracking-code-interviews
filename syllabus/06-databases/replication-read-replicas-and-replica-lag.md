...
- [CAP Theorem and Consistency Models](../10-distributed-systems/cap-theorem-and-consistency-models.md) — the broader distributed-systems framing (CP vs. AP trade-offs) that this chapter's PostgreSQL-specific replication mechanics sit within.
