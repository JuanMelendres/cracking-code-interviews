...
- **Holding a connection across a slow external call** — connects directly to the
  cascading-timeout mechanism covered in [Spring @Transactional](../05-spring/transactional-proxy-mechanics-and-propagation.md)'s
...
| Is a transaction boundary held open across a slow external call? | Fix the transaction scope first — see [Spring @Transactional](../05-spring/transactional-proxy-mechanics-and-propagation.md) |
