...
- [Deadlock, Race Conditions, and Thread Diagnostics](../02-java/concurrency/deadlock-race-conditions-and-thread-diagnostics.md) — the equivalent mental model and diagnostic discipline applied to Java thread deadlocks rather than database transactions.
