...
> **Scope note.** [Distributed Transactions: Saga, Outbox, and 2PC](../10-distributed-systems/distributed-transactions-saga-and-outbox.md)
...
- **Silent consumer failure in event notification** — if the callback a consumer makes
  ...
  See [Idempotency at System Edges](../11-system-design/idempotency.md) for why the retry
...
- **Schema drift in event-carried state transfer** — a producer adding a required
  ...
  change; see [Schema Registry and Compatibility Evolution](schema-registry-and-compatibility-evolution.md)
...
| Is this specifically a multi-step transaction needing compensation on failure? | See [Distributed Transactions: Saga, Outbox, and 2PC](../10-distributed-systems/distributed-transactions-saga-and-outbox.md) directly |
