...
- [CQRS: Read/Write Separation](../17-architecture/cqrs-read-write-separation.md) — another pattern whose event contract needs exactly this kind of compatibility discipline to evolve safely.
