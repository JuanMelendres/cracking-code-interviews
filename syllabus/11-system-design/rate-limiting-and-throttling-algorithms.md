...
[Atomics, CAS, and the ABA Problem](../02-java/concurrency/atomics-cas-and-the-aba-problem.md).
...
[Multi-Region, Failover, and Disaster Recovery](../10-distributed-systems/multi-region-failover-and-disaster-recovery.md).
