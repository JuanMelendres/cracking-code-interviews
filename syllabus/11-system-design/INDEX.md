...
The applied method and case studies: the six-phase design method plus all 18 Architecture Atlas systems (referenced from `architecture-atlas/`, not duplicated) — "how to design one, live, in 45 minutes."
