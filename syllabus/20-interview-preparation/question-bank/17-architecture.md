...
| 23 | Why can a "we have a rollback plan" migration still lose data on rollback? | [Strangler Fig and Migration Patterns](../../17-architecture/strangler-fig-and-migration-patterns.md#flashcards) |
| 24 | Why is "a rewrite would be faster" usually the wrong call for a legacy system? | [Strangler Fig and Migration Patterns](../../17-architecture/strangler-fig-and-migration-patterns.md#flashcards) |
| 25 | How does this chapter's use of Anti-Corruption Layer differ from its use in DDD? | [Strangler Fig and Migration Patterns](../../17-architecture/strangler-fig-and-migration-patterns.md#flashcards) |
