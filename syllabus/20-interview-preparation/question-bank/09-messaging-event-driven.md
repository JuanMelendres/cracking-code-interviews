...
| 4 | Why can a single unprocessable message halt processing of every message behind it on a partition? | [Consumer Lag, Backpressure, DLQ](../../09-messaging-event-driven/consumer-lag-backpressure-and-dlq-strategy.md#flashcards) |
| 5 | Does adding more consumer instances to a group always increase processing throughput? | [Consumer Lag, Backpressure, DLQ](../../09-messaging-event-driven/consumer-lag-backpressure-and-dlq-strategy.md#flashcards) |
| 6 | After committing an offset past a dead-lettered message, why might the consumer still reprocess it? | [Consumer Lag, Backpressure, DLQ](../../09-messaging-event-driven/consumer-lag-backpressure-and-dlq-strategy.md#flashcards) |
| 7 | What causes at-least-once duplicate processing? | [Delivery Semantics and Exactly-Once](../../09-messaging-event-driven/delivery-semantics-and-exactly-once.md#flashcards) |
| 8 | What causes at-most-once silent loss? | [Delivery Semantics and Exactly-Once](../../09-messaging-event-driven/delivery-semantics-and-exactly-once.md#flashcards) |
| 9 | Does Kafka's exactly-once cover a write to an external database? | [Delivery Semantics and Exactly-Once](../../09-messaging-event-driven/delivery-semantics-and-exactly-once.md#flashcards) |
| 10 | "Events decouple services" — true or false, and why? | [Event-Driven Architecture Integration Styles](../../09-messaging-event-driven/event-driven-architecture-integration-styles.md#flashcards) |
| 11 | Why can't you find the original cause of an event in a choreographed handler's call stack? | [Event-Driven Architecture Integration Styles](../../09-messaging-event-driven/event-driven-architecture-integration-styles.md#flashcards) |
| 12 | How does this chapter's choreography-vs-orchestration question differ from the Saga chapter's version? | [Event-Driven Architecture Integration Styles](../../09-messaging-event-driven/event-driven-architecture-integration-styles.md#flashcards) |
