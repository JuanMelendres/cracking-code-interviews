...
> **Question Bank complete (2026-09-14).** All 22 `syllabus/` domains mined into a
> seniority-tiered (Junior/Mid/Senior/Staff) interview-question compendium under
> [`question-bank/`](question-bank/), following the sourcing discipline in
> `00-project/interview-question-bank-plan.md`: mine each domain's own real
> `## Interview Questions` and `## Flashcards` content rather than inventing
> questions, split into multiple files where a domain's real chapter count
> exceeded pilot depth (`02-java` → 4 files, `21-frontend-web` → 3 files), and
> report honest per-domain counts rather than padding to a quota. **1181 real
> questions across all 22 domains.** Per-domain breakdown: [`06-databases.md`](question-bank/06-databases.md) (93, the pilot), `02-java` split into [`02-java-collections.md`](question-bank/02-java-collections.md) (52), [`02-java-concurrency.md`](question-bank/02-java-concurrency.md) (70), [`02-java-jvm-internals.md`](question-bank/02-java-jvm-internals.md) (31), [`02-java-language-core.md`](question-bank/02-java-language-core.md) (96), [`03-data-structures-algorithms.md`](question-bank/03-data-structures-algorithms.md) (36), [`04-software-design.md`](question-bank/04-software-design.md) (10), [`05-spring.md`](question-bank/05-spring.md) (61), [`07-api-design.md`](question-bank/07-api-design.md) (29), [`08-testing.md`](question-bank/08-testing.md) (25), [`09-messaging-event-driven.md`](question-bank/09-messaging-event-driven.md) (57), [`10-distributed-systems.md`](question-bank/10-distributed-systems.md) (39), [`11-system-design.md`](question-bank/11-system-design.md) (48), [`12-security.md`](question-bank/12-security.md) (46), [`13-observability.md`](question-bank/13-observability.md) (24), [`14-devops-containers.md`](question-bank/14-devops-containers.md) (22), [`15-cloud.md`](question-bank/15-cloud.md) (21), [`16-performance-jvm.md`](question-bank/16-performance-jvm.md) (15), [`17-architecture.md`](question-bank/17-architecture.md) (56), [`18-engineering-practices.md`](question-bank/18-engineering-practices.md) (14), [`19-leadership-staff.md`](question-bank/19-leadership-staff.md) (12), [`01-computer-science-foundations.md`](question-bank/01-computer-science-foundations.md) (10), [`20-interview-preparation.md`](question-bank/20-interview-preparation.md) (28, this domain's own self-referential mining), `21-frontend-web` split into [`21-frontend-web-foundations.md`](question-bank/21-frontend-web-foundations.md) (38), [`21-frontend-web-react.md`](question-bank/21-frontend-web-react.md) (56), [`21-frontend-web-nextjs.md`](question-bank/21-frontend-web-nextjs.md) (68), and [`22-ai-llm-engineering.md`](question-bank/22-ai-llm-engineering.md) (30). A real gap-count shortfall against the original ~150-per-domain target is expected and honestly documented per file — it reflects each domain's actual, real interview-question content, never padding.

> **Gap found and closed: Underperformance and Difficult Feedback Narratives (2026-09-21).** A gap audit found that [Handling Underperformance and Difficult Feedback Conversations](../19-leadership-staff/handling-underperformance-and-difficult-feedback.md) (T-1908, `19-leadership-staff`) — itself added the same day to close a real gap there — explicitly named this domain's own missing counterpart: none of the 16 existing `behavioral/` chapters covered narrating a real conversation about addressing a team member's genuine performance problem, distinct from [Conflict and Technical Disagreement](behavioral/06-conflict-and-technical-disagreement.md) (disagreement between peers each performing well) and [Mentoring and Developing Others](behavioral/07-mentoring-and-developing-others.md) (proactive growth coaching, not a performance problem). Closed with [Underperformance and Difficult Feedback Narratives](behavioral/underperformance-and-difficult-feedback-narratives.md) (T-1516), following this domain's own established `behavioral-handbook-chapter` template exactly, cross-linked in both directions with the `19-leadership-staff` skill chapter it narrates.
...
>
> **Two things deliberately were not moved**, per the plan's own rules: `practice/mock-interviews/` (12 real mock-interview transcripts) stays at its current path per Section 7.4 (`practice/` never relocates) — see the `mock-interviews/` subsection below for the reference-only index. `interview-playbook/company-prep/large-ecommerce-retailer-senior-backend-remote.md` stays exactly where it is, per the plan's own Section 7.2 sample mapping ("private — flagged, not migrated by default") and the Section 14 open-question-3 decision (approved 2026-09-03): this is a permanent, tooling-enforced private category, not something this migration touches.
>
...
| Underperformance and Difficult Feedback Narratives (T-1516, added 2026-09-21, gap audit) | — (new, not migrated) | `syllabus/20-interview-preparation/behavioral/underperformance-and-difficult-feedback-narratives.md` |
...
`interview-playbook/company-prep/large-ecommerce-retailer-senior-backend-remote.md` stays exactly where it is. See the note above.
