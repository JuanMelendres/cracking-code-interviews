...
> **Question Bank in progress (2026-09-13).** Pilot [`question-bank/06-databases.md`](question-bank/06-databases.md) (93 questions) approved; `02-java`'s 4 subdomain files ([`02-java-collections.md`](question-bank/02-java-collections.md) 52, [`02-java-concurrency.md`](question-bank/02-java-concurrency.md) 70, [`02-java-jvm-internals.md`](question-bank/02-java-jvm-internals.md) 31, [`02-java-language-core.md`](question-bank/02-java-language-core.md) 96) done next; [`question-bank/03-data-structures-algorithms.md`](question-bank/03-data-structures-algorithms.md) (36 — this domain has no Flashcards sections at all, so no quick-fire layer to mine) done after that. **472 real questions across 3 of 22 domains so far.** See `00-project/interview-question-bank-plan.md` for the full plan and sourcing discipline. 19 domains remain.
