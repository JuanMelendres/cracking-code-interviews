...
> **Question Bank: pilot approved, `02-java` complete (2026-09-13).** [`question-bank/06-databases.md`](question-bank/06-databases.md) (93 real questions) was the pilot; user approved the format and asked to continue. `02-java` — the largest domain (61 chapters) — is now done, split across 4 subdomain files matching its own real directory structure: [`question-bank/02-java-collections.md`](question-bank/02-java-collections.md) (52), [`question-bank/02-java-concurrency.md`](question-bank/02-java-concurrency.md) (70), [`question-bank/02-java-jvm-internals.md`](question-bank/02-java-jvm-internals.md) (31), [`question-bank/02-java-language-core.md`](question-bank/02-java-language-core.md) (96) — **249 real questions total for `02-java`**. See `00-project/interview-question-bank-plan.md` for the full 22-domain plan and sourcing discipline. 20 of 22 domains remain.
