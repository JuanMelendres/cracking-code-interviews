---
title: "Behavioral Handbook — Index"
document_type: behavioral-handbook-index
status: draft
...
Canonical home for behavioral-interview methodology — STAR delivery mechanics, story portfolio design, and the reusable narration frameworks for the specific story categories interviewers most often probe. This directory owns the *theory and structure*; the actual filled-in stories (built from the reader's own real experience, never fabricated) live in the reader's private worksheets, seeded by `study-packs/week-01/05-star-story-workbook.md`.
...
| # | Chapter | Topic ID | Covers |
|---|---|---|---|
| 1 | [STAR Framework and Delivery Mechanics](01-star-framework-and-delivery.md) | T-1501 | S/T/A/R structure, STAR-L/STAR-R extensions, three-length delivery system, level-specific failure modes |
| 2 | [Story Portfolio Design](02-story-portfolio-design.md) | T-1502 | The 13-slot competency matrix, sequencing, coverage-gap tracking |
| 3 | [Scope, Impact, and Influence Framing](03-scope-impact-and-influence-framing.md) | T-1503 | The Senior-to-Staff reframing lens, applied to any existing story |
...
- `study-packs/week-01/05-star-story-workbook.md` — the hands-on worksheet where Stories 1-2 get filled in, built directly on chapter 1's structure.
- `study-packs/week-05/07-story-scope-reframing.md` — the hands-on worksheet applying chapter 3's lens to Stories 1, 4, 7, 8.
- `study-packs/week-05/08-week-5-behavioral-mock.md`, `week-06/04-week-6-mock-design-behavioral.md`, `week-11/08-week-11-mock-behavioral.md`, `week-12/02-loop-2-...md`, `week-12/04-loop-4-...md` — the five dedicated (or partially-dedicated) behavioral mock-interview rounds already in this program, which these chapters give a canonical theoretical grounding to. They were not restated or duplicated here.
- `interview-playbook/behavioral/` — now has one entry, [Behavioral Interview-Day Logistics: Loop Structures and Question-Pattern Recognition](company-loop-structures-and-question-pattern-recognition.md), covering delivery-logistics content (question-shape recognition, loop-day story tracking) this directory deliberately does not — it references these chapters rather than restating them.
