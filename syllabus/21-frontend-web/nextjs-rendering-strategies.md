...
- [Caching Strategies and Invalidation](../11-system-design/caching-strategies-and-invalidation.md) — the backend-domain chapter this register topic is explicitly framed as a direct analogue of.
