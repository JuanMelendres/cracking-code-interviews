...
- [Rendering Strategies: SSR, SSG, and ISR — Mechanics and When to Choose Each](nextjs-rendering-strategies.md) — the next chapter in sequence (F-205); its ISR evidence cites this chapter's real timed and on-demand revalidation proofs directly rather than re-deriving them.
