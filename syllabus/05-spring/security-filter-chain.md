...
| Stateless (JWT-based) authentication in the chain | No session store lookup per request | The chain cannot revoke a still-valid token (see [OAuth2, OIDC, and JWT](../12-security/oauth2-oidc-and-jwt.md)) |
