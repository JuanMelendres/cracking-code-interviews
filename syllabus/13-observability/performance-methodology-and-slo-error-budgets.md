...
**Related references.** [Percentiles, Tail Latency, and Coordinated Omission](percentiles-tail-latency-and-coordinated-omission.md); [Resilience Patterns](../11-system-design/resilience-patterns.md).
