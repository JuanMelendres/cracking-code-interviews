...
status: 4 of 3 originally-planned chapters written — 3/3 closed 2026-09-10; T-1703 gap-audit addition 2026-09-21; fully L1-L4
...
>
> **Gap audit and closure (2026-09-21).** A further gap audit found "coupling" and "cohesion" named nowhere in this repository, despite being the vocabulary SOLID's own five principles collectively serve without ever naming — and the code-smell taxonomy (God Class, Feature Envy, Shotgun Surgery, Primitive Obsession, Data Clumps) had only one passing mention. Closed with [Coupling, Cohesion, and Code Smells](coupling-cohesion-and-code-smells.md) (T-1703), backed by a real demo (`practice/java/coupling-cohesion-and-code-smells/`): a reflection-measured God Class coupling count (5 distinct collaborators) dropping to 1 per class once decomposed (with the honest caveat that the new orchestrator's own count rises to 6); a Feature Envy method moved and verified byte-for-byte behavior-identical across 3 real orders; and a real Law of Demeter fragility measurement — an identical internal-structure change to a `Wallet` class produced 3 real compiler errors in train-wreck client code and 0 in Demeter-compliant client code.
