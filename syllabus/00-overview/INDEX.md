...
| 09 | [Messaging & Event-Driven Systems](../09-messaging-event-driven/INDEX.md) | 9/9 chapters relocated (Phase 3, 2026-09-03); **L1/L2 retrofit complete, 9/9** — fully L1–L4 (Phase 5, 2026-09-04); 12 chapters as of 2026-09-11 (gap audit filled two long-reserved slots — Retention/Log Compaction and Kafka Streams — plus Kafka Connect, a new topic; this domain's audit gaps are now fully closed) |
...
| 11 | [System Design](../11-system-design/INDEX.md) | 9/9 chapters relocated (Phase 3, 2026-09-03) + 21 Architecture Atlas case studies (referenced); **L1/L2 retrofit complete, 9/9** — fully L1–L4 (Phase 5, 2026-09-04); 18th–21st Atlas entries (Video Streaming Platform, Distributed File Storage System, Web Crawler System, Autocomplete/Typeahead System) added 2026-09-10/11 by a gap audit, beyond T-813's own closed 12-problem target — this Atlas follow-up set is now fully closed |
...
| 13 | [Observability](../13-observability/INDEX.md) | 4/4 chapters relocated (Phase 3, 2026-09-03); **L1/L2 retrofit complete, 4/4** — fully L1–L4 (Phase 5, 2026-09-04); 5 chapters as of 2026-09-11 (gap audit added Metric Cardinality and Alert Fatigue) |
