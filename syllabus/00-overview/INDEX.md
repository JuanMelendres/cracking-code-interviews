...
| 02 | [Java](../02-java/INDEX.md) | 49/49 chapters relocated (Phase 3, 2026-09-03); **L1/L2 retrofit complete, 49/49** — first fully L1–L4 domain (Phase 5, 2026-09-04); 59 chapters as of 2026-09-10 (gap audit added PriorityQueue Internals, java.time API, concurrency Synchronizers, and the Java Platform Module System filling its own long-reserved T-116 slot; MethodHandle and bytecode fundamentals remain open) |
...
| 10 | [Distributed Systems](../10-distributed-systems/INDEX.md) | 5/5 chapters relocated (Phase 3, 2026-09-03); **L1/L2 retrofit complete, 5/5** — fully L1–L4 (Phase 5, 2026-09-04); 6 chapters as of 2026-09-10 (gap audit added Consensus Algorithms and a real PACELC fix; vector clocks and quorum-based replication remain open) |
