...
| 02 | [Java](../02-java/INDEX.md) | 49/49 chapters relocated (Phase 3, 2026-09-03); **L1/L2 retrofit complete, 49/49** — first fully L1–L4 domain (Phase 5, 2026-09-04); 56 chapters as of 2026-09-10 (gap audit added PriorityQueue Internals; java.time, JPMS, MethodHandle, bytecode fundamentals, and concurrency synchronizers remain open) |
