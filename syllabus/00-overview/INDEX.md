...
| 11 | [System Design](../11-system-design/INDEX.md) | 9/9 chapters relocated (Phase 3, 2026-09-03) + 18 Architecture Atlas case studies (referenced); **L1/L2 retrofit complete, 9/9** — fully L1–L4 (Phase 5, 2026-09-04); 18th Atlas entry (Video Streaming Platform) added 2026-09-10 by a gap audit, beyond T-813's own closed 12-problem target — distributed file storage and web crawler/autocomplete remain open |
