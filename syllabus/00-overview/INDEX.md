...
| 11 | [System Design](../11-system-design/INDEX.md) | 9/9 chapters relocated (Phase 3, 2026-09-03) + 20 Architecture Atlas case studies (referenced); **L1/L2 retrofit complete, 9/9** — fully L1–L4 (Phase 5, 2026-09-04); 18th–20th Atlas entries (Video Streaming Platform, Distributed File Storage System, Web Crawler System) added 2026-09-10/11 by a gap audit, beyond T-813's own closed 12-problem target — autocomplete/typeahead remains open |
