...
> already covered in depth by [Secrets Management and Key Rotation](../12-security/secrets-management-and-key-rotation.md)
...
- **Not every one of the twelve factors needs its own deep chapter here.**
  ...
  ([Spring Boot Actuator, Health, and Observability Hooks](../05-spring/spring-actuator-health-and-observability-hooks.md)),
...
- **A secret accidentally committed to a config file in version control** —
  ...
  [Secrets Management and Key Rotation](../12-security/secrets-management-and-key-rotation.md)
...
| Is the value a credential, key, or anything sensitive? | Treat it as a secret specifically — see [Secrets Management and Key Rotation](../12-security/secrets-management-and-key-rotation.md), not plain config |
