...
3. Add a real heap-dump-based verification step (using `jmap` or
   ...
   technique from [Memory Leak Diagnosis and Heap Dump Analysis](../jvm-internals/memory-leak-diagnosis-and-heap-dump-analysis.md).
...
- [Classloaders and Class Initialization](../language-core/classloaders-and-class-initialization.md)
...
- [Memory Leak Diagnosis and Heap Dump Analysis](../jvm-internals/memory-leak-diagnosis-and-heap-dump-analysis.md)
