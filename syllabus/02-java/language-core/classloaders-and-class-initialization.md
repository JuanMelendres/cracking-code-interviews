...
related:
  - ../jvm-internals/jvm-memory-layout-and-runtime-regions.md
...
- [JVM Memory Layout and Runtime Regions](../jvm-internals/jvm-memory-layout-and-runtime-regions.md) — where a loaded class's metadata (method area/metaspace) actually lives once a classloader defines it.
