...
domain: 02-java
status: 49 of 49 mapped chapters physically relocated (Phase 3, 2026-09-03); L1/L2 retrofit in progress (Phase 5) — 36 of 49 done (collections + language-core + jvm-internals subdomains complete, 2026-09-04)
...
>
> **Phase 5 update (2026-09-04).** The `02-java/collections` subdomain (T-201–T-209, 9 chapters), the `02-java/language-core` subdomain (T-101–T-115, 15 chapters), and the `02-java/jvm-internals` subdomain (12 chapters — 7 with a Master Topic Register ID, T-302, T-303, T-303/T-306, T-305, T-309, T-310, T-311; 5 without one) have all now received the plan's own additive L1/L2 retrofit (§2.4): each chapter gained a new "Level 1 — Foundation" and "Level 2 — Working Knowledge" section, inserted between the existing "Why This Matters in Interviews" and "Mental Model" sections, per the plan's own stated placement. No existing sentence was deleted, reworded, or moved — every retrofit was a pure insertion, verified by diff. Each chapter also gained a `mastery_levels_covered: [L1, L2, L3, L4]` front-matter field, and a `topic_id` field where one already exists in the Master Topic Register (additive; existing fields untouched). Only `concurrency` (13 chapters) still carries L3/L4 only and is next in this retrofit.
