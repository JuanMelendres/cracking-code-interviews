...
Kubernetes objects/scheduling/networking, resource limits and probes, container image internals, CI/CD pipeline design, and horizontal pod autoscaling mechanics — the operational mechanics a backend engineer runs day-to-day. Split out of `cloud/` per Section 3.3.
