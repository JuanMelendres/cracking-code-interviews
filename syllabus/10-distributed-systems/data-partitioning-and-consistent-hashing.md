...
related:
  ...
  - ../09-messaging-event-driven/producer-semantics-and-partition-keys.md
...
**Related references.** [§ Core Concepts](#core-concepts); [Kafka Producer Semantics & Partition Key Design](../09-messaging-event-driven/producer-semantics-and-partition-keys.md).
