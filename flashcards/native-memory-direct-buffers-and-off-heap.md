...
**Related:**
[syllabus/02-java/jvm-internals/native-memory-direct-buffers-and-off-heap.md](../syllabus/02-java/jvm-internals/native-memory-direct-buffers-and-off-heap.md)
