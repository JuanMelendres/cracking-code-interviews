...
### Planned
- New gap category (foundational topics beyond this handbook's original Senior/Staff-depth scope): OOP (T-102) and Design Patterns (T-914) **closed** — the two topics the user asked to start with. Remaining, not yet scheduled: Java version-feature survey (Java 8→21), Spring-vs-Spring-Boot primer, Hibernate/JPA, Git/GitHub.
