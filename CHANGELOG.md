...
### Planned
- New gap: foundational topics beyond this handbook's original Senior/Staff-depth scope. OOP (T-102) closed this batch. Remaining, per the user's explicit request: Design Patterns (T-914) next, then user's own prioritization of Java version-feature survey, Spring-vs-Spring-Boot, Hibernate/JPA, and Git/GitHub — none yet scheduled.
