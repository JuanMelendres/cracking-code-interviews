...
### Planned
- Next: continue JVM depth (6 topics remaining, per the coverage audit), move to Testing (2/8, the next-thinnest domain with existing coverage), or start Phase 6 — undecided.
- Coding-problem volume gap (60 of 150–170 target) — largest single quantitative shortfall per the coverage audit, not yet addressed.
- Phase 6 complementary deliverables (interview-playbook, cheat-sheets, architecture-atlas, production-cookbook, behavioral-handbook) — not yet started.
