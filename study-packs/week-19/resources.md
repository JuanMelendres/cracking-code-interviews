...
| Source | Type | Notes |
|---|---|---|
| [`java.lang.ref` package documentation](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/ref/package-summary.html) | PRIMARY | Reference-strength hierarchy reference |
| [JEP 439: Generational ZGC](https://openjdk.org/jeps/439) | PRIMARY | ZGC design and generational enhancement |
| [JEP 379: Shenandoah](https://openjdk.org/jeps/379) | PRIMARY | Shenandoah design |
| [`java` command reference (Java 21)](https://docs.oracle.com/en/java/javase/21/docs/specs/man/java.html) | PRIMARY | Safepoint and diagnostic logging options |
