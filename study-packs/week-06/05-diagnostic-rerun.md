...
## D1 — Six questions cold

3 minutes each, no notes, recorded. These are the exact original six:

1. How does HashMap work internally?
2. What does `@Transactional` do?
3. When does an index not help?
4. Difference between hexagonal and layered architecture?
...
| Artifact | Day 0 baseline (brief note) | Week 6 result (brief note) | Delta |
|---|---|---|---|
| D1.1 HashMap internals | | | |
| D1.2 `@Transactional` | | | |
| D1.3 When index doesn't help | | | |
| D1.4 Hexagonal vs layered | | | |
| D1.5 Many-to-many modelling | | | |
| D1.6 "Why that design" | | | |
| D2 LRU Cache | | | |
| D3 URL shortener design | | | |
| D4 STAR story | | | |
