...
**Topics:** T-609 (Database Index Structures), T-605/T-608 (Data Modelling and Explicit Join Tables), T-2204 (Unit Testing Fundamentals with JUnit), T-1101/T-1103 (Test Strategy and Test Doubles). **Track:** Junior → Mid, Week 6 of 7.
...
Heaviest week in this pack (4 topics, 8h) — deliberately placed right before Week 7's Spring/REST work so testing habits are in place before any controller or service is written.
