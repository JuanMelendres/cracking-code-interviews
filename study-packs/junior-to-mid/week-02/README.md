---
title: "Junior → Mid, Week 2 — Numbers, Complexity, and Collections as a Concept"
...
# Week 2 — Numbers, Complexity, and Collections as a Concept
...
These three topics are the shared vocabulary the rest of this pack depends on: Week 3's `HashMap`/`ArrayList` internals assume you already know what a `Map`/`List` is *for* (this week's [Collections Usage Fundamentals](../../../syllabus/02-java/collections/java-collections-usage-fundamentals-list-map-and-set.md)), and Week 4's coding patterns assume you can already reason about complexity ([Algorithmic Complexity and Big-O](../../../syllabus/01-computer-science-foundations/algorithmic-complexity-and-big-o-from-first-principles.md)) without that being introduced mid-problem.

## Prerequisites

Week 1 — this week assumes you can read a class and a `for` loop without effort.
...
None dedicated this week — same reasoning as Week 1. Coding pattern practice starts Week 4.
...
Note any collection-choice mistake you made in this week's exercises (reaching for a `List` where a `Set` was right, or vice versa) — this is exactly the pattern Week 3's `HashMap`/`ArrayList` internals chapters build on.

## Next Week

[Week 3 — Collections, For Real This Time](../week-03/README.md).
