---
title: "Junior → Mid, Week 8 — Ship Something"
...
Weeks 1–7 — in particular, comfortable writing a class with a constructor (Week 2) and a `SELECT`/`JOIN` (Week 6) before this week's controller-service-repository stack.
