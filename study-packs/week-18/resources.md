...
| `syllabus/13-observability/percentiles-tail-latency-and-coordinated-omission.md` (T-1204) | INTERNAL | Owns the percentile-mathematics and coordinated-omission depth this week's load-testing chapter deliberately doesn't duplicate |
