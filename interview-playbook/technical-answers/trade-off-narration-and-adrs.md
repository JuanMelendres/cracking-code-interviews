...
**Situation:** choosing between a relational database and a document store for a new service (using [Storage Selection Trade-offs](../../handbook/system-design/storage-selection-tradeoffs.md)'s access-pattern method as the technical input).
